...
const setUpdatedList=(state,counter,userId, title)=>{
  const tasklist = {userId:userId, id:counter,title: title,completed:state.taskStatus};
  console.log(tasklist)
  console.log(state)
  state.todos[counter-1].title = title;
  state={
    ...state,
    todos:[...state.todos]
  }
